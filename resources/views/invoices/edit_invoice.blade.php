                ...
                <form action="{{ route('invoices.update', $invoice->id) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="input_name" name="invoice_number"
                                title="Please write invoice num" value="{{ $invoice->invoice_number }}" required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea class="form-control" id="exampleTextarea" value="{{ $invoice->notes }}" name="note" rows="3"></textarea>
                        </div>
                    </div><br>
