            ...
            <div class="col-xl-12">
                <div class="card mg-b-20">
                    <div class="card-header pb-0">
                            ...
                            @can('Export Invoice')
                            <a class="modal-effect btn btn-sm btn-primary" href="{{ url('invoice_export') }}"
                            ...
                            <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Vate Rate</th>
                                        <th class="border-bottom-0">Vate Value</th>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    @endcan
                                                        ...
                                                        <a class="dropdown-item" href="{{ url('print_invoice', $invoice->id) }}">
                                                            Print Invoice <i class="text-success fas fa-print"></i>&nbsp;&nbsp;
                                                        </a>
