...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Print Invoice Preview</span>
						</div>
					</div>
								...
								<div class="card-body" id="print">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>Release Date</span> <span>{{ $invoice->invoice_date }}</span></p>
									...
									<div class="table-responsive mg-t-40">
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													<td class="tx-right">VAT Rate ({{ $invoice->rate_vate }})</td>
									...
									<hr class="mg-b-40">
									<button class="btn btn-danger float-left mt-3 mr-2" id="print_button" onclick="printInvoice()">
