								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div  class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ url('/markread') }}">Mark All Read</a></span>
										</div>
										<p id="notif_count" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have {{ auth()->user()->unreadNotifications->count() }} unread Notifications</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										...
										<a class="d-flex p-3 border-bottom notif" data-notifid="{{ $notification->data['id'] }}" href="{{ url('InvoiceDetails') }}/{{ $notification->data['id'] }}">
