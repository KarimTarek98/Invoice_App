...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">Reports</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Customer Reports</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ url('/reports/customer_search') }}" method="GET" autocomplete="off">
                    @csrf
                    {{-- @method('PUT') --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3" id="start_at">
                            <label for="exampleFormControlSelect1">From date of</label>
            ...
            if (SectionId) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('select[name="product"]').append('<option value="all">All</option>')
